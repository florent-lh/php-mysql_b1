...
/*
Créez une fonction qui transforme une chaine de caractères en une suite de chiffres selon le codage du clavier téléphonique : 
ABC ⇒ 2
DEF ⇒ 3
GHI ⇒ 4
JKL ⇒ 5
...
Exemple : Le mot hello affichera 43556
*/


function telephone(string $mot)
{
      $mot = strtoupper($mot);
